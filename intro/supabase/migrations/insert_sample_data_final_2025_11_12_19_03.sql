...
ALTER TABLE public.user_profiles_2025_11_12_19_03 DROP CONSTRAINT IF EXISTS user_profiles_2025_11_12_19_03_user_id_fkey;
...
('aaaaaaaa-aaaa-1111-aaaa-111111111111', '11111111-1111-1111-1111-111111111111', '이천 1농장', 37.2722, 127.4350, 5.2, '벼', '점토'),
('bbbbbbbb-bbbb-2222-bbbb-222222222222', '11111111-1111-1111-1111-111111111111', '이천 2농장', 37.2800, 127.4400, 3.8, '콩', '사양토'),
('cccccccc-cccc-3333-cccc-333333333333', '22222222-2222-2222-2222-222222222222', '당진 대농장', 36.8934, 126.6275, 12.5, '벼', '점토'),
('dddddddd-dddd-4444-dddd-444444444444', '33333333-3333-3333-3333-333333333333', '나주 황금들', 35.0160, 126.7107, 8.7, '벼', '점토');
...
('aaaaaaaa-1111-aaaa-1111-aaaaaaaaaaaa', '44444444-4444-4444-4444-444444444444', 'DJI T40', 40.0, 25, 10.0, 6.5, 'available'),
('bbbbbbbb-2222-bbbb-2222-bbbbbbbbbbbb', '44444444-4444-4444-4444-444444444444', 'DJI T30', 30.0, 20, 8.0, 5.5, 'available'),
('cccccccc-3333-cccc-3333-cccccccccccc', '55555555-5555-5555-5555-555555555555', 'XAG P100 Pro', 50.0, 30, 12.0, 7.0, 'available'),
('dddddddd-4444-dddd-4444-dddddddddddd', '66666666-6666-6666-6666-666666666666', 'DJI T25', 25.0, 18, 7.0, 5.0, 'maintenance');
...
('aaaaaaaa-bbbb-2222-cccc-333333333333', '11111111-1111-1111-1111-111111111111', 'aaaaaaaa-aaaa-1111-aaaa-111111111111', 'pesticide', '2025-11-15', 5.2, '살충제', 'high', 'pending', 520000),
('bbbbbbbb-cccc-3333-dddd-444444444444', '22222222-2222-2222-2222-222222222222', 'cccccccc-cccc-3333-cccc-333333333333', 'fertilizer', '2025-11-18', 12.5, '복합비료', 'normal', 'pending', 1250000),
('cccccccc-dddd-4444-eeee-555555555555', '33333333-3333-3333-3333-333333333333', 'dddddddd-dddd-4444-dddd-444444444444', 'pesticide', '2025-11-20', 8.7, '제초제', 'urgent', 'pending', 870000);
...
('aaaaaaaa-1111-1111-1111-111111111111', 'aaaaaaaa-bbbb-2222-cccc-333333333333', '44444444-4444-4444-4444-444444444444', 'aaaaaaaa-1111-aaaa-1111-aaaaaaaaaaaa', 45, 480000, 0.92, 'proposed'),
('bbbbbbbb-2222-2222-2222-222222222222', 'bbbbbbbb-cccc-3333-dddd-444444444444', '55555555-5555-5555-5555-555555555555', 'cccccccc-3333-cccc-3333-cccccccccccc', 85, 1150000, 0.88, 'accepted');
...
('aaaaaaaa-1111-1111-1111-111111111111', 'bbbbbbbb-2222-2222-2222-222222222222', 'aaaaaaaa-1111-1111-1111-111111111111', 
